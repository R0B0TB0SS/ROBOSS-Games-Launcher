...
public class Bootstrap {
    ...
    public static void main(final String[] args) {
        ...
        if (data.getArch() != null && !data.getArch().contains("64"))
            NotificationHelper.sendSystemNotification("Configuration invalide", TrayIcon.MessageType.ERROR);
            ...
            try {
                ...
                if (tempLauncherFile.exists())
                    ...
                    if (distribution.version != null && !VERSION.equals(distribution.version)) {
                        ...
                        NotificationHelper.sendSystemNotification("Une mise à jour du launcher est disponible.", TrayIcon.MessageType.INFO);
